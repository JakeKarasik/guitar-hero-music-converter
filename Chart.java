...
public class Chart {
    ...
    public Chart(ChartAlgo algo, SongData data) {
        this.name = data.name; // name of song
        this.artist = data.artist; // artist of song
        this.resolution = data.resolution;
        this.music_stream = data.music_stream; //song file
        setSongData();
        setSyncTrack();
        setEvents();
        write();
